...
def process_fillings_for_cik(cik, root_folder_fillings):
...
if __name__ == '__main__':
    root_folder = 'total_sp500_10q-html' # Input folder
    root_folder_fillings = 'total_sp500_10q-txt' # Output folder
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=os.cpu_count()) as executor:
        ...
        for cik in os.listdir(root_folder):
            ...
            future = executor.submit(process_fillings_for_cik, cik, root_folder_fillings)
