...
with DAG(
    dag_id="portfolio_10q_dict_builder",
    schedule="0 0 2 1,4,7,10 *",
    ...
    csv_file_path = '/opt/airflow/data/top10_QQQ_constituents.csv'
    ...
    def download_executor(firm_list_path, type, start_date, end_date):
        ...
        download_fillings(QQQ_cik_ticker, data_raw_folder, doc_type ,headers, start_time, end_time)
    ...
    t2_download_executor = download_executor(csv_file_path, type, start_date, end_date)
