...
with DAG(
    ...
    sec10k_10k_extracted_folder = f'/opt/airflow/data/{firms_ciks[0]}_{type}_all_txt'
    sec10k_item1a_extracted_folder = f'/opt/airflow/data/{firms_ciks[0]}_{type}_riskFactor_txt' 

    error_html_csv_path = f'opt/airflow/data/logs/error_{level}_{type}_html-log.csv'
    error_txt_csv_path = f'opt/airflow/data/logs/error_{level}_{type}_txt-log.csv'   
