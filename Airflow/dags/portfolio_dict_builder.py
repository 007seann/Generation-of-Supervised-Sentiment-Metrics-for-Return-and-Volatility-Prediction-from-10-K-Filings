...
with DAG(
    ...
    data_raw_folder = '/opt/airflow/data/top10_data'
    sec10k_10k_extracted_folder = '/opt/airflow/data/top10_txt_data'
    sec10k_item1a_extracted_folder = '/opt/airflow/data/top10_item1a_data'
    ...
    # firm_list_path = '/Users/apple/PROJECT/Code_4_10k/top10_QQQ_constituents.csv'
        ...
        cik_tickers = {cik: ticker for cik, ticker in QQQ_cik_ticker.items() if cik in q10_cik_ticker_prob }
        ...
        download_fillings(cik_tickers, root_folder,doc_type,headers,end_date=end_date,start_date=start_date)
