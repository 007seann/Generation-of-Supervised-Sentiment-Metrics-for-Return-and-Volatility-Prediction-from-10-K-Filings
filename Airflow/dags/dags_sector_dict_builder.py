...
with DAG(
    ...
    data_raw_folder = '/opt/airflow/data/QQQ_data'
    sec10k_10k_extracted_folder = '/opt/airflow/data/QQQ_txt_data'
    sec10k_item1a_extracted_folder = '/opt/airflow/data/QQQ_item1a_data'
